...
const routes: Routes = [
  ...
  { path: 'case-history', component: CaseHistoryScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'customer'] } },
  { path: 'message-status', component: MessageStatusScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'customer'] } },
  { path: 'case-page', component: CasePageComponent, canActivate: [AuthGuard], data: { roles: ['customer'] } },
  { path: 'package-selection', component: PackageSelectionScreenComponent, canActivate: [AuthGuard], data: { roles: ['customer'] } },
  { path: 'mobile-management', component: MobileScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'customer'] } },
  { path: 'feedback-list', component: FeedbackScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin'] } },
  { path: 'customer-complaints', component: CustomerComplaintsScreenComponent, canActivate: [AuthGuard], data: { roles: ['customer'] } },
  { path: 'complaints-list', component: ComplaintsScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin'] } },
  { path: 'transactions', component: TransactionsScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'customer'] } },
  { path: 'payment', component: PaymentScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'customer'] } },
  { path: 'profile-modify', component: ProfileModificationScreenComponent, canActivate: [AuthGuard], data: { roles: ['admin', 'customer'] } },
